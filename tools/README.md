...
| File | What it does |
| --- | --- |
| `theme_shot.py` | What does a theme actually look like? The last step of #2194's method, which ends "then look at it on the glass" — every palette decision here was taken from a picture, and the two-column picker was found in one while every test passed against it. |
