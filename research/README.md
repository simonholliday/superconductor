...
| `rig-clock/` | Added 2026-09-13: timing the rig's real rebuilds and Subsequence's stock clock across tempos, the two levers that removed the clock's lateness, and what placing a drum step at its own velocity costs | #2532, #2533, #2534, #2525 |
