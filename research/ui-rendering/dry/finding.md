...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DOM | 128 | incremental | 0.02 (0.1) | 0.14 (0.3) | 0.03 (0.1) | 0.04 (0.2) | 0.17 (0.5) | 0.04 (0.2) | 0.17 (0.5) | 0 / 0 / 0 |
| DOM | 128 | full | 0.06 (0.2) | 0.11 (0.2) | 0.05 (0.2) | 0.07 (0.3) | 0.19 (0.5) | 0.07 (0.3) | 0.19 (0.5) | 0 / 0 / 0 |
| DOM | 1024 | incremental | 0.06 (0.2) | 0.31 (0.6) | 0.07 (0.2) | 0.09 (0.3) | 0.48 (0.9) | 0.09 (0.3) | 0.48 (0.9) | 0 / 0 / 0 |
| DOM | 1024 | full | 0.27 (0.5) | 0.51 (1.0) | 0.23 (0.5) | 0.29 (0.7) | 0.84 (1.2) | 0.29 (0.7) | 0.84 (1.2) | 0 / 0 / 0 |
| SVG | 128 | incremental | 0.04 (0.1) | 0.17 (0.3) | 0.04 (0.2) | 0.04 (0.2) | 0.21 (0.6) | 0.04 (0.2) | 0.21 (0.6) | 0 / 0 / 0 |
| SVG | 128 | full | 0.09 (0.2) | 0.21 (0.5) | 0.10 (0.3) | 0.10 (0.3) | 0.33 (0.7) | 0.10 (0.3) | 0.33 (0.7) | 0 / 0 / 0 |
| SVG | 1024 | incremental | 0.09 (0.2) | 0.41 (0.8) | 0.07 (0.2) | 0.10 (0.3) | 0.66 (1.0) | 0.10 (0.3) | 0.66 (1.0) | 0 / 0 / 0 |
| SVG | 1024 | full | 0.61 (1.1) | 0.92 (1.9) | 0.66 (0.9) | 1.04 (1.4) | 1.75 (2.2) | 1.03 (1.4) | 1.75 (2.2) | 0 / 0 / 0 |
| Canvas 2D | 128 | incremental | 0.11 (0.2) | n/a | 0.06 (0.2) | 0.08 (0.3) | n/a | 0.08 (0.3) | n/a | 0 / 0 / 0 |
| Canvas 2D | 128 | full | 0.35 (0.7) | n/a | 0.19 (0.4) | 0.35 (0.8) | n/a | 0.35 (0.8) | n/a | 0 / 0 / 0 |
| Canvas 2D | 1024 | incremental | 0.23 (0.4) | n/a | 0.11 (0.3) | 0.15 (0.4) | n/a | 0.15 (0.4) | n/a | 0 / 0 / 0 |
| Canvas 2D | 1024 | full | 1.56 (2.4) | n/a | 1.64 (1.8) | 3.22 (3.7) | n/a | 3.22 (3.7) | n/a | 0 / 0 / 0 |
| WebGL 2 | 128 | incremental | 0.03 (0.1) | n/a | 0.03 (0.1) | 0.06 (0.3) | n/a | 0.06 (0.3) | n/a | 49 / 1 / 1 |
| WebGL 2 | 128 | full | 0.02 (0.1) | n/a | 0.04 (0.2) | 0.07 (0.4) | n/a | 0.07 (0.4) | n/a | 5 / 0 / 0 |
| WebGL 2 | 1024 | incremental | 0.02 (0.1) | n/a | 0.05 (0.3) | 0.09 (0.6) | n/a | 0.09 (0.6) | n/a | 6 / 80 / 80 |
| WebGL 2 | 1024 | full | 0.04 (0.1) | n/a | 0.06 (0.3) | 0.11 (0.7) | n/a | 0.11 (0.7) | n/a | 3 / 77 / 77 |
...
| --- | --- | --- | --- | --- | --- |
| SVG polygon, 400 bins, 1920x256, rewritten every frame | 1.15 (1.5) | 0.57 (1.0) | 0.83 (1.2) | 0.83 (1.2) | 0 / 0 / 0 |
| Canvas path fill, same data | 0.11 (0.2) | 0.05 (0.2) | 0.06 (0.2) | 0.06 (0.2) | 0 / 0 / 0 |
| Mixed page: 512 DOM cells incremental, 8 transform faders, 1 canvas waveform | 0.47 (1.0) | 0.45 (0.6) | 0.81 (1.1) | 0.81 (1.1) | 0 / 0 / 0 |
...
- Incremental updates are what keep the Pi in reach. Rewriting only the playhead columns and the toggled cells costs 0.3 ms with style and layout at 1024 cells on the desktop and under 0.5 ms at 4x throttling; a full rewrite is about twice that. The rule "change only what changed" is worth more than the choice of technique.
- Canvas 2D is the cheapest for a few cells and the most expensive for a whole grid. A full redraw of 1024 rounded rectangles is 1.6 ms on the desktop and 3.2 ms at 4x, because each cell is a path; dirty-rectangle redraws bring it to the DOM's level. Canvas wins outright for the waveform: a full redraw at 1920x256 is 0.1 ms against 1.2 ms for the equivalent SVG `points` rewrite.
...
- WebGL's JavaScript cost is flat and negligible at both sizes, but it was the only technique to produce long frames here: 49 of 300 on the desktop at 128 cells and about 80 of 300 at 4x throttling at 1024 cells. Under SwiftShader the per-frame buffer upload and rasterisation of a 1920x1080 WebGL surface land on the throttled thread; on a Pi whose Chromium has fallen back to software GL the same would happen. With a working GPU it would be the fastest path, which is the wrong bet for a surface that must work on whatever Chromium the Pi image ships.
- The mixed page (512 live cells, eight animated faders, one redrawn waveform) costs under 1 ms of main-thread time per frame at 4x throttling and never missed a frame. A realistic Superintendent page is not near the budget on the main thread; if it misses frames on a Pi it will be paint and raster, which this harness cannot throttle and which only the hardware can measure.
